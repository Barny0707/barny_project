            ...
            <div class="col-9" style="width: 70%; padding: 7rem 0;">
                ...
                <table class="table" style="font-size: 13px; border-top : solid 1px; border-top-color: #dee2e6;">
                    <form action="modify" method="post">
                        ...
                        <tr>
                            <td> 제목 </td>
                            <td> <input type="text" class="form-control_2" name="b_title" value="${content_view.b_title}"></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="submit" value="수정" class="btn-basic text-uppercase"> &nbsp;&nbsp; <a
                                    href="adminList" class="btn-basic text-uppercase">목록보기</a> &nbsp;&nbsp;
                                <a id="a-delete"
                                    href="${pageContext.request.contextPath}/board/delete?board_id=${content_view.board_id}"
                                    class="btn-basic text-uppercase">삭제</a>
                                &nbsp;&nbsp; <a href="reply_view?board_id=${content_view.board_id}"
